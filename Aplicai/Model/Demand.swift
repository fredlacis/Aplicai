...
//    Demand(ownerUser: User.emptyBusiness, title: "Dar aulas de robótica para crianças via zoom", categorys: ["Engenharia Elétrica"], location: "Rio de Janeiro", image: UIImage(named: "image1")?.jpegData(compressionQuality: 0.1), estimatedDuration: "Média Duração", deadline: Date(), groupSize: 3, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue tincidunt elit eget varius. Nunc a eleifend enim, ac dapibus leo. Quisque ac aliquet nunc, a lacinia lorem. Sed bibendum sagittis purus sed semper. Maecenas suscipit tellus metus, et aliquet est rutrum vitae. Duis non sagittis arcu."),
//    Demand(ownerUser: User.emptyBusiness, title: "Criar obras de arte mecânicas", categorys: ["Engenharia", "Design"], location: "São Paulo", image: UIImage(named: "image2")?.jpegData(compressionQuality: 0.1), estimatedDuration: "Curta Duração", deadline: Date(), groupSize: 1, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue tincidunt elit eget varius. Nunc a eleifend enim, ac dapibus leo. Quisque ac aliquet nunc, a lacinia lorem. Sed bibendum sagittis purus sed semper. Maecenas suscipit tellus metus, et aliquet est rutrum vitae. Duis non sagittis arcu. Nulla ante ante, volutpat sed vehicula vulputate, maximus in libero. Integer eu finibus justo. Sed quis felis sed mi cursus efficitur ac eu lacus. Pellentesque cursus libero ac nunc condimentum, eu scelerisque est semper. Pellentesque consequat lacus ut luctus convallis. Quisque blandit orci ac odio posuere pellentesque. Aliquam erat volutpat."),
//    Demand(ownerUser: User.emptyBusiness, title: "Desenvolver software para controle de estoque", categorys: ["Administração", "Computação", "Engenharia"], location: "São Paulo", image: UIImage(named: "image3")?.jpegData(compressionQuality: 0.1), estimatedDuration: "Longa Duração", deadline: Date(), groupSize: 6, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue tincidunt elit eget varius. Nunc a eleifend enim, ac dapibus leo. Quisque ac aliquet nunc, a lacinia lorem. Sed bibendum sagittis purus sed semper. Maecenas suscipit tellus metus, et aliquet est rutrum vitae. Duis non sagittis arcu. Nulla ante ante, volutpat sed vehicula vulputate, maximus in libero. Integer eu finibus justo. Sed quis felis sed mi cursus efficitur ac eu lacus. Pellentesque cursus libero ac nunc condimentum, eu scelerisque est semper. Pellentesque consequat lacus ut luctus convallis. Quisque blandit orci ac odio posuere pellentesque. Aliquam erat volutpat.")
...
extension Demand {
    ...
    func ckSaveDemand(then completion:@escaping (Result<Demand, Error>)->Void) {
        print("savig demand")
        
        var demandRecord: CKRecord?
        
        if self.recordName == nil {
            print("demand not exists")
            do {
            ...
            print("saved as record")
        } else {
            print("demand existis")
